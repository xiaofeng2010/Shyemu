...
//            type |= SPELL_TYPE_WARLOCK_CURSES;
		...
		if( sp->NameHash == SPELL_HASH_ASPECT_OF_THE_HAWK )
		{
			sp->procFlags = PROC_ON_RANGED_ATTACK;
			sp->procChance = 10;
		}

		if( sp->NameHash == SPELL_HASH_ASPECT_OF_THE_DRAGONHAWK )
		{
			sp->procFlags = PROC_ON_RANGED_ATTACK;
			sp->procChance = 10;
		}

		if( sp->NameHash == SPELL_HASH_ASPECT_OF_THE_MONKEY )
		{
	...
	for(uint32 x=0; x < cnt; x++)
	{
		...
		sp = dbcSpell.LookupEntryForced(51634);
		if(sp != NULL)
		{		
			sp->procFlags = PROC_ON_CRIT_ATTACK;
			sp->procChance = 33;
		}
		sp = dbcSpell.LookupEntryForced(51635);
		if(sp != NULL)
		{		
			sp->procFlags = PROC_ON_CRIT_ATTACK;
			sp->procChance = 66;
		}
		sp = dbcSpell.LookupEntryForced(51636);
		if(sp != NULL)
		{		
			sp->procFlags = PROC_ON_CRIT_ATTACK;
			sp->procChance = 100;
		...
		if( sp != NULL )
		{
			sp->EffectTriggerSpell[0] = 14531;
			sp->procChance = 50;
			sp->procFlags = PROC_ON_RANGED_CRIT_ATTACK_VICTIM | PROC_ON_CRIT_HIT_VICTIM;
		}
		...
		if( sp->NameHash == SPELL_HASH_FLAMETONGUE_TOTEM )
		{
			sp->Effect[0] = 6;
			sp->Effect[1] = 6;
			sp->EffectImplicitTargetA[0] = 37;
			sp->EffectImplicitTargetB[0] = 0;
			sp->EffectImplicitTargetA[1] = 37;
		...
		if(sp->NameHash == SPELL_HASH_WINDFURY_WEAPON || sp->NameHash == SPELL_HASH_FLAMETONGUE_WEAPON || sp->NameHash == SPELL_HASH_ROCKBITER_WEAPON || sp->NameHash == SPELL_HASH_FROSTBRAND_WEAPON ||	sp->NameHash == SPELL_HASH_EARTHLIVING_WEAPON)
		{
			sp->AttributesExC |= FLAGS3_ENCHANT_OWN_ONLY;
		}
		...
		if( sp != NULL)
		{
			...
			sp->EffectApplyAuraName[1] = 40885;
		}
	...
	// Flametongue weapon
	sp = dbcSpell.LookupEntryForced( 10400 );	// Rank 1
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 15567 );	// Rank 2
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 15568 );	// Rank 3
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 15569 );	// Rank 4
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 16311 );	// Rank 5
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 16312 );	// Rank 6
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 16313 );	// Rank 7
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 58784 );	// Rank 8
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 58791 );	// Rank 9
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	sp = dbcSpell.LookupEntryForced( 58792 );	// Rank 10
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		sp->procFlags =	PROC_ON_MELEE_ATTACK;
	...
	**********************************************************/
	...
	if(sp != NULL)
	{
		...
		if(sp != NULL)
		{
		    ...
		    sp->EffectTriggerSpell[1] = 64976;
			sp->EffectApplyAuraName[1] = 262;
		}
		...
		if( sp != NULL ){
			...
			sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->procChance = 20;
			sp->EffectTriggerSpell[0] = 35546;
			sp->procFlags = PROC_ON_MELEE_ATTACK;
			sp->proc_interval = 1000;
		}
		sp = dbcSpell.LookupEntryForced( 35552 );
		if( sp != NULL ){
			sp->Effect[0] = 6;
			sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->procChance = 20;
			sp->EffectTriggerSpell[0] = 35547;
			sp->procFlags = PROC_ON_MELEE_ATTACK;
			sp->proc_interval = 1000;
		}
		sp = dbcSpell.LookupEntryForced( 35553 );
		if( sp != NULL ){
			sp->Effect[0] = 6;
			sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->procChance = 20;
			sp->EffectTriggerSpell[0] = 35548;
			sp->procFlags = PROC_ON_MELEE_ATTACK;
			sp->proc_interval = 1000;
		}
		/**********************************************************
		...
		sp = dbcSpell.LookupEntryForced(48571);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		sp = dbcSpell.LookupEntryForced(48572);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		...
		// Typhoon
		sp = dbcSpell.LookupEntryForced( 61391 ); // Rank1
		if( sp != NULL)
		{
			sp->EffectImplicitTargetA[0] = 24;
			sp->EffectImplicitTargetA[1] = 24;
			sp->EffectImplicitTargetA[2] = 24;
			/*sp->Effect[0] = 6;
			sp->EffectApplyAuraName[0] = 31;
			sp->EffectMiscValue[0] = -50;*/
		}
		// Typhoon
		sp = dbcSpell.LookupEntryForced( 61390 ); // Rank2
		if( sp != NULL)
		{
			sp->EffectImplicitTargetA[0] = 24;
			sp->EffectImplicitTargetA[1] = 24;
		...
		// Typhoon
		sp = dbcSpell.LookupEntryForced( 61388 ); // Rank3
		if( sp != NULL)
		{
			sp->EffectImplicitTargetA[0] = 24;
			sp->EffectImplicitTargetA[1] = 24;
		...
		// Typhoon
		sp = dbcSpell.LookupEntryForced( 61387 ); // Rank4
		if( sp != NULL)
		{
			sp->EffectImplicitTargetA[0] = 24;
			sp->EffectImplicitTargetA[1] = 24;
		...
		// Typhoon
		sp = dbcSpell.LookupEntryForced( 53227 ); // Rank5
		if( sp != NULL)
		{
			sp->EffectImplicitTargetA[0] = 24;
			sp->EffectImplicitTargetA[1] = 24;
        ...
        // Starfall
		sp = dbcSpell.LookupEntryForced( 50294 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 50286 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53196 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53188 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53197 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53189 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53198 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		 // Starfall
		sp = dbcSpell.LookupEntryForced( 53190 );
		if( sp != NULL)
			sp->EffectImplicitTargetA[0] = 22;
		...
		//Spirit wolf leap
		sp = dbcSpell.LookupEntryForced( 58867 );
		if( sp != NULL )
			sp->Effect[1] = 5;
	...
	// Insert rogue spell fixes here
		...
		sp = dbcSpell.LookupEntryForced(48689);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		sp = dbcSpell.LookupEntryForced(48690);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		sp = dbcSpell.LookupEntryForced(48691);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		...
		sp = dbcSpell.LookupEntryForced(48656);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
		sp = dbcSpell.LookupEntryForced(48657);
		if(sp != NULL)
		{
			sp->FacingCasterFlags = SPELL_INFRONT_STATUS_REQUIRE_INBACK;
		}
...
*/
	...
	// Insert warlock spell fixes here
		sp = dbcSpell.LookupEntryForced( 706 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 1086 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 11733 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 11734 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 11735 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 27260 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 47793 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 47889 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 28176 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 28189 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 47892 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 47893 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 687 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		sp = dbcSpell.LookupEntryForced( 696 );
		if (sp != NULL)
		{
			sp->AuraInterruptFlags |= AURA_INTERRUPT_ON_CAST_SPELL;
		}
		...
		if(sp != NULL)
		{
			sp->Effect[1] = SPELL_EFFECT_SUMMON_OBJECT_SLOT1;
			sp->EffectMiscValue[1] = 191083;
	...
	// Insert items spell fixes here
		...
		sp = dbcSpell.LookupEntryForced( 60698 );
		if( sp != NULL )
		{
			sp->procFlags = PROC_ON_CAST_SPECIFIC_SPELL;
			sp->ProcOnNameHash[0] = SPELL_HASH_MANGLE;
		...
		sp = dbcSpell.LookupEntryForced( 60700 );
		if( sp != NULL )
		{
			sp->procFlags = PROC_ON_CAST_SPECIFIC_SPELL;
			sp->ProcOnNameHash[0] = SPELL_HASH_MANGLE;
		...
		sp = dbcSpell.LookupEntryForced( 53061 );
		if( sp != NULL )
		{
			sp->RequiresAreaId = 4360;
		}

		sp = dbcSpell.LookupEntryForced( 53063 );
		if( sp != NULL )
		{
			sp->RequiresAreaId = 4360;
		}
...
// #endif
		...
		*/
		...
		sp = dbcSpell.LookupEntryForced( 42612 );
		if( sp != NULL )
			sp->procFlags = PROC_ON_CAST_SPELL;

		// Hateful Gladiator's Libram of Justice
        sp = dbcSpell.LookupEntryForced( 42613 );
		if( sp != NULL )
			sp->procFlags = PROC_ON_CAST_SPELL;

        // Deadly Gladiator's Libram of Justice
        sp = dbcSpell.LookupEntryForced( 42614 );
		if( sp != NULL )
			sp->procFlags = PROC_ON_CAST_SPELL;

		// Furious Gladiator's Libram of Justice
        sp = dbcSpell.LookupEntryForced( 42615 );
		if( sp != NULL )
			sp->procFlags = PROC_ON_CAST_SPELL;

		// Relentless Gladiator's Libram of Justice
        sp = dbcSpell.LookupEntryForced( 42616 );
		if( sp != NULL )
			sp->procFlags = PROC_ON_CAST_SPELL;
	   ...
	   sp = dbcSpell.LookupEntryForced( 63624 );
	   if( sp != NULL)
	   {
		   sp->Effect[1] = SPELL_EFFECT_TRIGGER_SPELL;
	   ...
	   // Nitro Boosts
	   sp = dbcSpell.LookupEntryForced( 54861 );
	   if( sp != NULL)
	   {
		   sp->EffectApplyAuraName[0] = 31;
