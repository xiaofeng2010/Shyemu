...
SHYEMU_INLINE bool CanToggleAtWar( uint8 flag ) { return ( flag & FACTION_FLAG_DISABLE_ATWAR ) == 0 ; }
SHYEMU_INLINE bool AtWar( uint8 flag ) { return ( flag & FACTION_FLAG_AT_WAR ) != 0; }
SHYEMU_INLINE bool ForcedInvisible( uint8 flag ) { return ( flag & FACTION_FLAG_FORCED_INVISIBLE ) != 0; }
SHYEMU_INLINE bool Visible( uint8 flag ) { return ( flag & FACTION_FLAG_VISIBLE ) != 0; }
SHYEMU_INLINE bool Hidden( uint8 flag ) { return ( flag & FACTION_FLAG_HIDDEN ) != 0; }
SHYEMU_INLINE bool Inactive( uint8 flag ) { return ( flag & FACTION_FLAG_INACTIVE ) != 0; }

SHYEMU_INLINE bool SetFlagAtWar( uint8 &flag, bool set )
{
	if ( set && !AtWar( flag ) )
...
SHYEMU_INLINE bool SetFlagVisible( uint8 &flag, bool set )
{
...
SHYEMU_INLINE bool SetFlagInactive( uint8 &flag, bool set )
{
...
SHYEMU_INLINE bool RankChanged( int32 Standing, int32 Change )
{
	return ( Player::GetReputationRankFromStanding( Standing ) != Player::GetReputationRankFromStanding( Standing + Change ) );
}

SHYEMU_INLINE bool RankChangedFlat( int32 Standing, int32 NewStanding )
{
