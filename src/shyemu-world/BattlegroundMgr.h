...
public:
	...
	SHYEMU_INLINE uint32 GetLevelGroup() { return m_levelGroup; }
	SHYEMU_INLINE MapMgr* GetMapMgr() { return m_mapMgr; }
	...
	/* Has it ended? */
	SHYEMU_INLINE bool HasEnded() { return m_ended; }
	/* Has it started? */
	SHYEMU_INLINE bool HasStarted() { return m_started; }
	...
	/* Full? */
	SHYEMU_INLINE bool IsFull() { return !(HasFreeSlots(0,m_type) || HasFreeSlots(1,m_type)); }
	...
	SHYEMU_INLINE uint32 GetStartTime() { return m_startTime; }
	SHYEMU_INLINE uint32 GetType() { return m_type; }
	...
	SHYEMU_INLINE uint32 GetLastResurrect() { return m_lastResurrect; }
