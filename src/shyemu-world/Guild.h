...
public:
	...
	/** Gets MOTD
	 */
	SHYEMU_INLINE const char * GetMOTD() const { return m_motd; }
	 ...
	 */
	SHYEMU_INLINE const char * GetGuildInformation() const { return m_guildInfo; }
	...
	/** Getters :P
	 */
	SHYEMU_INLINE const char * GetGuildName() const { return m_guildName; }
	SHYEMU_INLINE const uint32 GetGuildLeader() const { return m_guildLeader; }
	SHYEMU_INLINE const uint32 GetGuildId() const { return m_guildId; }
	SHYEMU_INLINE const uint8  GetBankTabCount() const { return ( uint8) m_bankTabs.size(); }
	SHYEMU_INLINE const uint64 GetBankBalance() const { return m_bankBalance; }
	SHYEMU_INLINE const size_t GetNumMembers() const { return m_members.size(); }
	 ...
	 */
	SHYEMU_INLINE GuildRank * GetGuildRank(uint32 Id)
	{ 
	...
	SHYEMU_INLINE GuildBankTab * GetBankTab( uint8 Id )
	{
	 ...
	 */
	SHYEMU_INLINE GuildMember * GetGuildMember(PlayerInfo * pInfo)
	{
	...
	/* Get iterators */
	SHYEMU_INLINE GuildMemberMap::iterator GetGuildMembersBegin() { return m_members.begin(); }
	SHYEMU_INLINE GuildMemberMap::iterator GetGuildMembersEnd() { return m_members.end(); }

	/* Get, Lock, Unlock Mutex */
        SHYEMU_INLINE Mutex& getLock() { return m_lock; }
	SHYEMU_INLINE void Lock() { m_lock.Acquire(); }
	SHYEMU_INLINE void Unlock() { return m_lock.Release(); }
