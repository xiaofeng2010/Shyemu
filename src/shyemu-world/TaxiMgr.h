...
public:
	...
	SHYEMU_INLINE uint32 GetID() { return id; }
	...
	SHYEMU_INLINE size_t GetNodeCount() { return m_pathNodes.size(); }
	TaxiPathNode* GetPathNode(uint32 i);
	SHYEMU_INLINE uint32 GetPrice() { return price; }
	SHYEMU_INLINE uint32 GetSourceNode() { return from; }
