...
#define shyemu_QUEST_REPEATABLE 1
#define shyemu_QUEST_REPEATABLE_DAILY 2
...
public:
	...
	SHYEMU_INLINE Quest* GetQuest() { return m_quest; };
	...
	SHYEMU_INLINE bool IsCastQuest() { return iscastquest;}
	SHYEMU_INLINE bool IsEmoteQuest() { return isemotequest; }
	...
	SHYEMU_INLINE uint32 GetMobCount(uint32 i) { return m_mobcount[i]; }
	SHYEMU_INLINE uint32 GetExploredAreas(uint32 i) { return m_explored_areas[i]; }

	SHYEMU_INLINE uint32 GetBaseField(uint32 slot)
	{
