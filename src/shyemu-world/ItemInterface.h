...
public:
	...
	//buyback stuff
	SHYEMU_INLINE Item* GetBuyBack(int32 slot) 
	{ 
...
public:
	SHYEMU_INLINE bool VerifyBagSlots(int8 ContainerSlot, int8 Slot)
	{
...
public:
	...
	SHYEMU_INLINE Item* Grab() { return m_currentItem; }
	SHYEMU_INLINE bool End() { return m_atEnd; }
};
