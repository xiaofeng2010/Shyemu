...
struct LocalizedInstanceStringTable
{
	char * Text;
};
...
public:
	...
	LocalizedInstanceStringTable *	GetLocalizedInstanceStringTable(uint32 id, uint32 language);
...
private:
	...
	HM_NAMESPACE::hash_map<uint32, LocalizedInstanceStringTable>			* m_InstanceStrings;
