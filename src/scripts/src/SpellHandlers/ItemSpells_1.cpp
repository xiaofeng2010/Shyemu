...
bool HeadlessHorsemanMount(uint32 i, Aura * pAura, bool apply)
{
	...
	if(pPlayer->HasSpell(34090) && ((pArea->AreaFlags & 1024 && pPlayer->GetMapId() != 571) || (pArea->AreaFlags & 1024 && pPlayer->GetMapId() == 571 && pPlayer->HasSpellwithNameHash(SPELL_HASH_COLD_WEATHER_FLYING))))
	{
		if(pPlayer->HasSpell(34091))
			newspell = 48023;
		else
	...
	else if(pPlayer->HasSpell(33391))
		newspell = 48024;			
	else
		newspell = 51621;
