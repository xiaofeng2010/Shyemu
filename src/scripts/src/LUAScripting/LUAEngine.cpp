...
RegType<Unit> UnitMethods[] = {
	...
	{ "AddAuraVisual", NULL },
	{ "GetSummon", &luaUnit_GetSummon },
	{ "IsInParty", &luaUnit_IsInParty },
	{ "IsInRaid", &luaUnit_IsInRaid },
	{ "IsCasting", &luaUnit_IsCasting },
	{ "GetDeathState", &luaUnit_GetDeathState },
	{ "GetStandState", &luaUnit_GetStandState },
	{ "ShareHealth", &luaUnit_ShareHealth },
	/* End Date : 01/05/2009 */
	/* Date : 01/07/2009 */
	{ "SetUInt32Value", &luaUnit_SetUInt32Value },
	{ "SetUInt64Value", &luaUnit_SetUInt64Value },
	...
	{ "DisableFlight", &luaUnit_DisableFlight },
	{ "AttackReaction", &luaUnit_AttackReaction },
	{ "IsInWorld", &luaUnit_IsInWorld },
	{ "PlaySpellVisual", &luaUnit_PlaySpellVisual },
	{ "ImmuneMechanic", &luaUnit_ImmuneMechanic },
	/* End Date : 01/07/2009 */
	/* Date : 01/13/2009 */
	{ "GetCurrentWaypoint", &luaUnit_GetCurrentWaypoint },
	{ "SetAllowedToEnterCombat", &luaUnit_SetAllowedToEnterCombat },
	{ "GetDistanceSq",&luaUnit_GetDistanceSq },
	{ "SetOutOfCombatRange", &luaUnit_SetOutOfCombatRange },
	{ "SetSpawnLocation", &luaUnit_SetSpawnLocation },
	{ "GetInRangeUnits", &luaUnit_GetInRangeUnits },
	{ "DeleteAllWaypoints", &luaUnit_DeleteAllWaypoints },
	{ "DeleteWaypoint", &luaUnit_DeleteWaypoint },
	{ "ChangeWaypoint", &luaUnit_ChangeWaypoint },
	{ "SaveInstanceToDB", &luaUnit_SaveInstanceToDB },
	{ "ResetSavedInstances", &luaUnit_ResetSavedInstances },
...
RegType<GameObject> GOMethods[] = {
	...
	{ "GetInRangeGameObjects", &luaGameObject_GetInRangeGameObjects },
	...
	{ "CalcDistance", &luaGameObject_CalcDistance },
	{ "SetO", &luaGameObject_SetOrientation },
	...
	//{ "OnGameObjectEvent", &luaGameObject_OnGameObjectEvent },
	...
	/* Date : 01/09/2009 */
	{ "SetSpawnPosition", &luaGameObject_SetSpawnPosition },
	{ "SaveToDB", &luaGameObject_SaveToDB },
	{ "DeleteFromDB", &luaGameObject_DeleteFromDB },
	{ "WorldQuery", &luaGameObject_WorldQuery },
...
int luaUnit_GetSummon(lua_State * L, Unit * ptr)
	{
		CHECK_TYPEID(TYPEID_PLAYER);
		Pet * pPet = static_cast<Player*>(ptr)->GetSummon();
		( (pPet != NULL) ? Lunar<Unit>::push(L,pPet) : lua_pushnil(L) );
		return 1;
	}
int luaUnit_IsInParty(lua_State * L, Unit * ptr)
	{
		CHECK_TYPEID(TYPEID_PLAYER);
...
int luaUnit_GetDeathState(lua_State * L, Unit * ptr)
	{
		lua_pushinteger(L, uint32(ptr->getDeathState()) );
		return 1;
	}

	int luaUnit_ImmuneMechanic(lua_State * L, Unit * ptr)
	{
		uint32 mechanic = luaL_checkint(L,1);
	...
	int luaUnit_SetAllowedToEnterCombat(lua_State * L, Unit * ptr)
	{
		CHECK_TYPEID(TYPEID_UNIT);
	...
	int luaUnit_ChangeWaypoint(lua_State * L , Unit * ptr)
	{
	...
	int luaUnit_SaveInstanceToDB(lua_State * L, Unit * ptr)
	{
		/*CHECK_TYPEID(TYPEID_PLAYER);
		shared_ptr<Player> plr = static_cast<Player*>(ptr);
	...
	int luaUnit_SetSpawnLocation(lua_State * L, Unit * ptr)
	{
		CHECK_TYPEID(TYPEID_UNIT);
		double x = luaL_checknumber(L,1);
		double y = luaL_checknumber(L,2);
	...
	int luaUnit_ResetSavedInstances(lua_State * L, Unit * ptr)
	{
		CHECK_TYPEID(TYPEID_PLAYER);
		Player * plr = static_cast<Player*>(ptr);
	...
	int luaUnit_GetDistanceSq(lua_State * L, Unit * ptr)
	{
	...
	int luaUnit_ShareHealth(lua_State * L, Unit * ptr)
	{
		Unit * target = Lunar<Unit>::check(L,1);
	...
	int luaUnit_GetStandState(lua_State * L, Unit * ptr)
	{
	...
	int luaUnit_EnableFlight(lua_State * L, Unit * ptr)
	{
		...
		else if(ptr->IsPlayer())
		{
			data << ptr->GetGUID();
			data << uint32(2);
			static_cast<Player*>(ptr)->SendMessageToSet(&data,true);
			return 0;
		}
		else return 0;
	}
	int luaUnit_DisableFlight(lua_State * L, Unit * ptr)
	{
...
int luaGameObject_Despawn(lua_State * L, GameObject * ptr)
	{
		...
		static_cast<GameObject*>(ptr)->Despawn(delay, respawnt);
...
int luaGameObject_SaveToDB(lua_State * L, GameObject * ptr)
	{
		CHECK_TYPEID(TYPEID_GAMEOBJECT);
		ptr->SaveToDB();
		return 0;
	}
int luaGameObject_DeleteFromDB(lua_State * L, GameObject * ptr)
	{
		CHECK_TYPEID(TYPEID_GAMEOBJECT);
		ptr->DeleteFromDB();
		return 0;
	}
int luaGameObject_WorldQuery(lua_State * L, GameObject * ptr)
	{
...
int luaGameObject_SetSpawnPosition(lua_State * L, GameObject * ptr)
	{
		CHECK_TYPEID(TYPEID_GAMEOBJECT);
...
/*int luaGameObject_RegisterAIUpdateEvent(lua_State * L, GameObject * ptr)
	{
		...
		if(!time) return 0;
		sEventMgr.AddEvent(static_cast<GameObject*>(this),&GameObject::CallScriptUpdate,EVENT_GAMEOBJECT_UPDATE,time,0,0);
		return 0;
	}*/
