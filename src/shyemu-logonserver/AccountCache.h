...
public:
	...
	SHYEMU_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	...
	SHYEMU_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	SHYEMU_INLINE Mutex & getRealmLock() { return realmLock; }
	...
	SHYEMU_INLINE void   AddServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.insert( sock ); serverSocketLock.Release(); }
	SHYEMU_INLINE void   RemoveServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.erase( sock ); serverSocketLock.Release(); }
