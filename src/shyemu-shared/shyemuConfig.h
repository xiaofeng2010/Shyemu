...
// shyemu Configuration Header File
// Feel free to customize to your needs.

#ifndef __shyemuCONFIG_H
#define __shyemuCONFIG_H
...
/** Enable/disable shyemu's Voice Chat support.
 * While not completely finished (but close!) you can link your shyemu server to a voice chat
 ...
 * Enable it if you do not plan on using shyemu with PostgreSQL or SQLite.
 */
