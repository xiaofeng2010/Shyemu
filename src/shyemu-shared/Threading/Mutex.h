...
public:
	 ...
	 */
	SHYEMU_INLINE bool AttemptAcquire()
	{
#ifndef WIN32
...
public:
	SHYEMU_INLINE FastMutex() : m_lock(0),m_recursiveCount(0) {}
	SHYEMU_INLINE ~FastMutex() {}
