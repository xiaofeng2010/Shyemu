...
#define STORAGE_ARRAY_MAX 999999999
...
public:
	 ...
	 */
	SHYEMU_INLINE T * Get() { return Pointer; }

	/** Sets the current object to P
	 */
	SHYEMU_INLINE void Set(T * P) { Pointer = P; }

	/** Are we at the end of the storage container?
	 */
	SHYEMU_INLINE bool AtEnd() { return (Pointer == 0); }
...
public:
	...
	SHYEMU_INLINE char * GetIndexName() { return _indexName; }
	SHYEMU_INLINE char * GetFormatString() { return _formatString; }
...
public:
	 ...
	 */
	SHYEMU_INLINE void LoadBlock(Field * fields, T * Allocated, bool reload = false )
	{
