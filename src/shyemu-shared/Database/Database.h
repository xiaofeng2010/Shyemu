...
public:
	...
	void Perform();
	SHYEMU_INLINE void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	SHYEMU_INLINE const string& GetHostName() { return mHostname; }
	SHYEMU_INLINE const string& GetDatabaseName() { return mDatabaseName; }
	SHYEMU_INLINE const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	SHYEMU_INLINE Field* Fetch() { return mCurrentRow; }
	SHYEMU_INLINE uint32 GetFieldCount() const { return mFieldCount; }
	SHYEMU_INLINE uint32 GetRowCount() const { return mRowCount; }
